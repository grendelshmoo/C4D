...
class SearchForm(forms.Form):
    ...
    document_date = forms.CharField(max_length=10, label="Document Date", required=False)
    recording_date = forms.CharField(max_length=10, label="Recording Date", required=False)
