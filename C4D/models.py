...
class RawLandRecord(models.Model):
    ...
    grantor = models.CharField(max_length=512, blank=True, null=True)
    grantee = models.CharField(max_length=512, blank=True, null=True)
    title_company = models.CharField(max_length=512, blank=True, null=True)
    legal_description = models.CharField(max_length=1024, blank=True, null=True)
