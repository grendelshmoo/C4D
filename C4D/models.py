...
class RawLandRecord(models.Model):
    ...
    document_date = models.CharField(max_length=64, blank=True, null=True)
    ...
    lot = models.CharField(max_length=64, blank=True, null=True, db_index=True)
    block = models.CharField(max_length=32, blank=True, null=True, db_index=True)
    tract = models.CharField(max_length=32, blank=True, null=True, db_index=True)
    ...
    increment = models.CharField(max_length=32, blank=True, null=True)
    lot_sf = models.CharField(max_length=32, blank=True, null=True)
    building_sf = models.CharField(max_length=32, blank=True, null=True)
    map_document = models.CharField(max_length=32, blank=True, null=True)
    building_type = models.CharField(max_length=32, blank=True, null=True)
    year_built = models.CharField(max_length=32, blank=True, null=True)
    ...
    lcdn = models.CharField(max_length=32, blank=True, null=True)
